...
class ErrorDisplayPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ErrorDisplayPage> createState() => _DisplayPageState();
}

class _DisplayPageState extends ConsumerState<ErrorDisplayPage> {
